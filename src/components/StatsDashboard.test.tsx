...
const FIXTURE_TASKS: Task[] = [
  {
    id: 1, title: "Diseñar API", description: "Definir contratos REST",
    status: "todo", sdd_phase: null, workspace_id: 1,
    priority_id: 4, category_id: 1, due_date: "2024-01-10T00:00:00.000Z",
    created_at: "2024-01-01T00:00:00.000Z", updated_at: "2024-01-02T00:00:00.000Z",
    priority_name: "Urgente", priority_color: "#D91515", priority_level: 4,
    category_name: "Desarrollo", category_color: "#7C5CFC",
  },
  {
    id: 2, title: "Maquetar dashboard", description: "Layout de estadísticas",
    status: "in_progress", sdd_phase: null, workspace_id: 1,
    priority_id: 2, category_id: 2, due_date: "2024-02-15T00:00:00.000Z",
    created_at: "2024-01-05T00:00:00.000Z", updated_at: "2024-01-06T00:00:00.000Z",
    priority_name: "Media", priority_color: "#FF9900", priority_level: 2,
    category_name: "Diseño", category_color: "#FF9900",
  },
  {
    id: 3, title: "Escribir tests", description: "Cobertura de utilidades",
    status: "done", sdd_phase: null, workspace_id: 1,
    priority_id: 3, category_id: 1, due_date: "2024-01-20T00:00:00.000Z",
    created_at: "2024-01-08T00:00:00.000Z", updated_at: "2024-01-19T00:00:00.000Z",
    priority_name: "Alta", priority_color: "#D91515", priority_level: 3,
    category_name: "Desarrollo", category_color: "#7C5CFC",
  },
  {
    id: 4, title: "Investigar mercado", description: "Análisis de competidores",
    status: "done", sdd_phase: null, workspace_id: 1,
    priority_id: 1, category_id: 4, due_date: null,
    created_at: "2024-01-03T00:00:00.000Z", updated_at: "2024-01-12T00:00:00.000Z",
    priority_name: "Baja", priority_color: "#037F0C", priority_level: 1,
    category_name: "Investigación", category_color: "#D91515",
  },
];
