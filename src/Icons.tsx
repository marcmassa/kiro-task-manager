...
export function KanbanIcon({ className = "", size = 20 }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M216,48H40A16,16,0,0,0,24,64V192a16,16,0,0,0,16,16H216a16,16,0,0,0,16-16V64A16,16,0,0,0,216,48Zm0,144H168V80h48ZM152,80v112H104V80ZM40,64H88V192H40Z" />
    </svg>
  );
}
...
export function FireIcon({ className = "", size = 20 }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M143.38,17.85a8,8,0,0,0-12.63,3.41l-22,60.41L84.59,58.26a8,8,0,0,0-11.93,2.17C51.53,93.8,40,120.49,40,144a88,88,0,0,0,176,0C216,84.55,165.21,36,143.38,17.85Zm40.51,135.49a57.6,57.6,0,0,1-7.18,20.18,59.52,59.52,0,0,1-14.38,16.41,8,8,0,1,1-9.81-12.62,43.16,43.16,0,0,0,10.44-11.91A41.81,41.81,0,0,0,168.12,148a8,8,0,0,1,15.77-2.69Z" />
    </svg>
  );
}
...
export function TargetIcon({ className = "", size = 20 }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M221.87,83.16A104.1,104.1,0,1,1,172.84,34.13,8,8,0,0,1,166.3,49.6a88.08,88.08,0,1,0,40.1,40.1,8,8,0,1,1,15.47-6.54ZM128,24a8,8,0,0,0,0,16,88.1,88.1,0,0,1,88,88,8,8,0,0,0,16,0A104.11,104.11,0,0,0,128,24Zm0,48a56,56,0,1,0,56,56A56.06,56.06,0,0,0,128,72Zm0,96a40,40,0,1,1,40-40A40,40,0,0,1,128,168Z" />
    </svg>
  );
}
...
export function LayersIcon({ className = "", size = 20 }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M220,169.09l-92,53.65L36,169.09a8,8,0,0,0-8,13.82l96,56a8,8,0,0,0,8.06,0l96-56a8,8,0,1,0-8.06-13.82ZM24,80a8,8,0,0,1,4-6.91l96-56a8,8,0,0,1,8.06,0l96,56a8,8,0,0,1,0,13.82l-96,56a8,8,0,0,1-8.06,0l-96-56A8,8,0,0,1,24,80Zm23.88,0L128,126.74,208.12,80,128,33.26ZM220,121.09l-92,53.65L36,121.09a8,8,0,0,0-8,13.82l96,56a8,8,0,0,0,8.06,0l96-56a8,8,0,1,0-8.06-13.82Z" />
    </svg>
  );
}
